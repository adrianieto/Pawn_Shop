...
import pawnshop.controller.Joyas;
import pawnshop.model.ArticuloBean;

public class JoyasFrame extends JFrame {

	private static final long serialVersionUID = -4175417773075701799L;
	...
	public JoyasFrame(MainWindow mainFrame){
		super("Departamento de Joyeria");
		setSize(500,315);

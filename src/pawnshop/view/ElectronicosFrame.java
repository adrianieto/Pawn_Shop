...
import pawnshop.controller.Electronicos;
import pawnshop.model.ArticuloBean;


public class ElectronicosFrame extends JFrame {
	...
	public ElectronicosFrame(MainWindow mainFrame){
	...
	private List<ArticuloBean> getTableData(){
		articuloData = Electronicos.getInstance();
